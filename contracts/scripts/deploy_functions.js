async function deployFunctions() {
  ...
  const { abi, bytecode } = require('../artifacts/contracts/YourFunctionContract.sol/YourFunctionContract.json');
  ...
  const yourFunctionContract = await contractFactory.deploy('yourFunctionContract');
